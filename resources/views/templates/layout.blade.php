...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('/dashboard/surat')}}" data-toggle="collapse" data-target="#collapseTwo"
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/dashboard/surat')}}">Manage Surat</a>
                        <a class="collapse-item" href="{{url('/dashboard/surat/tambah')}}">Tambah Surat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('/dashboard/jenissurat')}}" data-toggle="collapse" data-target="#collapseUtilities"
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/dashboard/jenissurat')}}">Manage Jenis Surat</a>
                        <a class="collapse-item" href="{{url('/dashboard/jenissurat/tambah')}}">Tambah Jenis Surat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('/dashboard/manage-pengguna')}}" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/dashboard/manage-pengguna')}}">Manage Pengguna</a>
                        <a class="collapse-item" href="{{url('/dashboard/manage-pengguna/tambah')}}">Tambah Penggguna</a>
                    </div>
                </div>
            </li>
